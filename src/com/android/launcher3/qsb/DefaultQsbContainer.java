...
public class DefaultQsbContainer extends ExtendedEditText implements OnUpdateListener, Callbacks {
    ...
    private AllAppsSearchBarController mController;
    ...
    public AllAppsSearchBarController getController() {
        return mController;
    }
    ...
    public void setAppList(AlphabeticalAppsList list) {
        mApps = list;
    }

    public AllAppsContainerView getAppView() {
        return mAppsView;
    }

    public void setAppView(AllAppsContainerView v) {
        mAppsView = v;
    }

    public AllAppsQsbContainer getContainer() {
        return mAllAppsQsb;
    }

    public void setContainer(AllAppsQsbContainer container) {
        mAllAppsQsb = container;
    }
}
